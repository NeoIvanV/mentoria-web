                    ...
                    <?php foreach ($users as $user) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="create.php?id=<?= $user['id'] ?>"><button class="btn btn-primary btn-sm">Create</button></a>
                            <td>  
                                <form method="POST" action="index.php">
                                <input type="hidden" name="id" value=" <?= $user['id'];?> ">
                                <button class="btn btn-danger"  onclick="return confirm('Esta seguro que desea borrar el archivo?');" name="btnEliminar">Eliminar</button>
                                </form>
                            </td>    
                            </td>
                        </tr>
